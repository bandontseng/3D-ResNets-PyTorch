...
def get_fine_tuning_parameters(model, ft_begin_index):
    ...
    ft_module_names.append('features.14')  # (14): Mixed_5b
    ft_module_names.append('features.15')  # (15): Mixed_5c
    ft_module_names.append('features.18')  # (18): Conv3d
